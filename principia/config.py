...
def get_settings() -> Settings:
    ...
    efficient_model = os.getenv("PRINCIPIA_EFFICIENT_MODEL", "Qwen/Qwen3.6-27B")
    if "Qwen2.5-7B" in efficient_model:
        efficient_model = os.getenv("PRINCIPIA_QWEN_27B_MODEL", "Qwen/Qwen3.6-27B")
    return Settings(
        api_key=api_key,
        ...
        model_aliases={
            "efficient": efficient_model,
            "qwen_27b": os.getenv("PRINCIPIA_QWEN_27B_MODEL", "Qwen/Qwen3.6-27B"),
            ...
            "deepseek_r1": os.getenv("PRINCIPIA_DEEPSEEK_R1_MODEL", "deepseek-ai/DeepSeek-R1"),
            ...
            "qwen_397b": os.getenv("PRINCIPIA_QWEN_397B_MODEL", "Qwen/Qwen3.5-397B-A17B"),
